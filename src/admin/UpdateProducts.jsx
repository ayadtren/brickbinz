...
const UpdateProduct = () => {
  ...
  useEffect(() => {
    const fetchAllShowProduct = async () => {
      try {
        ...
        {showProduct.map((product) => {
          return (
            <form onSubmit={handleClick}>
              <Grid container spacing={3} key={product.product_set_numb}>
                <Grid item xs={12}>
                  <TextField
                    fullWidth
                    label="Set Name"
                    variant="outlined"
                    placeholder={product.product_set_name}
                    name="setName"
                ...
                <Grid item xs={12}>
                  <TextField
                    ...
                    variant="outlined"
                    placeholder={product.product_location}
                    name="setLocation"
                    onChange={handleChange}
                    required
                  />
                ...
                <Grid item xs={12}>
                  <TextField
                    ...
                    label="Image"
                    variant="outlined"
                    placeholder={product.product_img}
                    name="setImage"
                    onChange={handleChange}
                    required
                  />
